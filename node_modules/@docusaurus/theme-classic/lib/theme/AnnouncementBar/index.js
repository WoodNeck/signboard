...
function AnnouncementBar() {
  ...
  return <div className={_stylesModule.default.announcementBar} style={{
    ...
    dangerouslySetInnerHTML={{
      ...
      {isCloseable ? <button type="button" className={(0, _clsx.default)(_stylesModule.default.announcementBarClose, 'clean-btn')} onClick={closeAnnouncementBar} aria-label={(0, _Translate.translate)({
