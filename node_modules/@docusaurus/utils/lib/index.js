...
const docuHash_1 = require("./docuHash");
exports.posixPath = posixPath_1.posixPath;
tslib_1.__exportStar(require("./getFilePathForRoutePath"), exports);
...
tslib_1.__exportStar(require("./docuHash"), exports);
var pathUtils_2 = require("./pathUtils");
Object.defineProperty(exports, "simpleHash", { enumerable: true, get: function () { return pathUtils_2.simpleHash; } });
...
function genComponentName(pagePath) {
    ...
    const pageHash = docuHash_1.docuHash(pagePath);
...
function genChunkName(modulePath, prefix, preferredName, shortId = process.env.NODE_ENV === 'production') {
    ...
    if (!chunkName) {
        if (shortId) {
            chunkName = pathUtils_1.simpleHash(modulePath, 8);
        }
        else {
            let str = modulePath;
            if (preferredName) {
                const shortHash = pathUtils_1.simpleHash(modulePath, 3);
                str = `${preferredName}${shortHash}`;
            }
            const name = str === '/' ? 'index' : docuHash_1.docuHash(str);
